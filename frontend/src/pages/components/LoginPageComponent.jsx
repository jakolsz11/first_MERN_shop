...
function LoginPageComponent({ loginUserApiRequest, reduxDispatch, setReduxUserState }) {
      ...
      <Row className="mt-5 justify-content-md-center">
        <Col md={6}>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Alert className="mt-3" variant="danger" show={loginUserResponseState && loginUserResponseState.error === "wrong credentials"}>Wrong credentials</Alert>
